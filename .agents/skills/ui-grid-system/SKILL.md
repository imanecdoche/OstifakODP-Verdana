---
name: ui-grid-system
description: Strictly enforces the 8-Point Grid System with 4-Point baseline sub-grid for all frontend, React, JSX, HTML, and Tailwind CSS code. Eliminates arbitrary pixel values and guarantees mathematical visual rhythm.
---
