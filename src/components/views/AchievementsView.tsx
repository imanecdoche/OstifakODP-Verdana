...
export const AchievementsView: React.FC<AchievementsViewProps> = ({
  ...
  // Submit Manual Achievement Form
  ...
  return (
    <div className="space-y-6 pb-16 font-body">
      ...
      {/* 5. Tabel Rekam Jejak Prestasi (Clean Flat Table, Thin Dividers, No Badges) */}
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-[#E2E8F0]">
              {filteredAchievements.length === 0 ? (
                <tr>
                  <td colSpan={7} className="p-8 text-center text-xs text-[#64748B] font-body">
      ...
      {/* MODAL 2: PREVIEW & EKSEKUSI OTOMASI PP BULANAN (21:00 WIB) */}
      {isAutoPreviewOpen && (
        <div data-lenis-prevent className="fixed inset-0 z-50 flex items-center justify-center bg-[#0F172A]/50 backdrop-blur-xs p-3 sm:p-4 overflow-y-auto overscroll-contain font-body">
